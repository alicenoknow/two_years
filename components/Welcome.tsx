...
const Welcome = () => {
  return (
    <div className="flex items-center justify-center z-10 px-4 pt-4 md:px-96 md:pt-24">
      <CroissantEmoji />
      <h1 className="mb-4 text-4xl font-extrabold z-10 leading-[4rem] text-gray-900 dark:text-white text-2xl md:text-3xl lg:text-4xl">Dokładnie 2 lata temu podjąłeś 
